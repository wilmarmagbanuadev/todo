   ...
   return (
        <View style={styles.container}>
          <ImageBackground source={image} resizeMode="cover" style={styles.bgImage}>
              <View style={{position:'absolute',top:20,width:'100%',paddingHorizontal:20}}>
              ...
              <View>
              <TouchableOpacity style={{backgroundColor:'#0076ff',paddingVertical:10,paddingHorizontal:20,marginVertical:30,borderRadius:40}} >
